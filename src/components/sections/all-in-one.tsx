      ...
      >
        ...
        >
          ...
          <div className="p-6 md:p-8 h-full flex flex-col relative z-10">
            ...
            <div className="relative flex-1 min-h-[420px] bg-black/40 rounded-2xl border border-zinc-800/80 overflow-hidden group-hover:scale-[1.02] group-hover:border-zinc-700 transition-all duration-500 shadow-2xl">
              <Image
                src="https://cdn.btbon.cn/images/plugin-ui.webp"
        ...
        >
          ...
          <div className="relative z-10 h-full flex flex-col justify-between">
            ...
            <div>
              <div className="text-5xl font-bold text-zinc-300 group-hover:text-yellow-400 transition-colors duration-300 mb-2">360+</div>

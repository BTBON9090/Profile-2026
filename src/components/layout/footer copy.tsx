...
export default function Footer() {
  return (
    <footer className="bg-black py-20 border-t border-zinc-900 overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-4 md:px-8 text-center relative z-10">
        ...
        <motion.div
          ...
          className="mb-20"
        >
          <p className="font-mono text-blue-500 mb-6 tracking-widest uppercase text-sm">
            Available for new opportunities
          </p>
          <p className="font-mono text-white mb-6 tracking-widest uppercase text-sm">
            Let's Talk.
          </p>
          {/* 超大号邮箱，鼠标悬停时有扫光效果 */}
          <a 
            href="mailto:nc0032@qq.com" 
            className="text-4xl md:text-8xl font-bold text-white hover:text-transparent bg-clip-text bg-gradient-to-r from-white via-zinc-400 to-white bg-[length:200%_auto] hover:animate-shimmer transition-all duration-300"
          >
            nc0032@qq.com
          </a>
        </motion.div>
